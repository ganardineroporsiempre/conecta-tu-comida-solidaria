      ...
      <div className="conecta-container py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-fade-in">
            <div className="inline-block bg-conecta-orange-100 text-conecta-orange-600 px-4 py-1.5 rounded-full text-sm font-semibold">
              Mercado Solidario y Banco de Alimentos Digital
            </div>
            ...
            <p className="text-gray-600 text-lg md:text-xl">
              ...
              Compra con descuento, dona fácilmente y genera impacto social.
            </p>
