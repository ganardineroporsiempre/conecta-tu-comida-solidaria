      ...
      <div className="conecta-container">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto">
            ComidaConecta es una plataforma fácil de usar que conecta excedentes de alimentos 
            con personas que los necesitan, generando un impacto social positivo.
          </p>
        </div>
            ...
            <div key={index} className="text-center">
              <div className="relative mb-8">
                ...
                {index < steps.length - 1 && (
                  <div className="hidden lg:block absolute top-10 left-full w-full h-0.5 bg-gray-200" style={{ width: "calc(100% - 5rem)" }}></div>
                )}
              </div>
